...
Note that each plot has a toolbar (move mouse to the top right of the plot area to show it) that is as shown below. The default zoom tool is selected to allow you to drag a rectangle
